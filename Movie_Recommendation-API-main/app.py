...
app = Flask(__name__)
CORS(app)
movies = pd.read_csv('D:\ddu\sem6\sdp\mm\Movie_Recommendation-API-main\cleaned_movie_dataset.csv')
featuresForClient = ['id', 'title', 'popularity', 'genres', 'cast', 'director','keywords', 'overview']
# featuresForClient = ["id"	,"title"	,"description",	"genre[0]","	genre[1]",	"genre[2]" ,	"releaseYear",	"poster",	"cast[0].name"	,"cast[1].name",	"cast[0].photo","	cast[1].photo"	,"cast[0]._id	", "cast[1]._id"	,"vote_average",	"vote_count"]
# featuresForClient = [
#     "id", 
#     "title", 
#     "description", 
